    ...
    <article className="px-10 pb-28">
      ...
      <PortableText value={post.body} components={RichTextComponents} />
       <a href="/" className="relative inline-block text-lg group mb-10 mt-10">
        ...
        <span
          className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-[#222]  dark:bg-[#F7AB0A] rounded-lg group-hover:mb-0 group-hover:mr-0"
